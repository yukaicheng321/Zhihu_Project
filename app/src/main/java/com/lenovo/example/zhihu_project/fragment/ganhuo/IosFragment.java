...
public class IosFragment extends BaseFragment implements GanHuoContract.View {
    ...
    protected void initData() {
        ((GanhuoPresenter) persenter).getHttp(Constant.TECH_IOS, 20, 1);
    ...
    public void getHttpResult(GankHttpResponse<List<GankItemBean>> listGankHttpResponse) {
        ...
        ganhuoAndroidAdapter = new GanhuoAndroidAdapter(results, Constant
                .TECH_IOS);
    ...
    public void getSearchResult(GankHttpResponse<List<GankSearchItemBean>> listGankHttpResponse) {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(context);
        recycGanhuoAndroid.setLayoutManager(manager);
        GanhuoSearch ganhuoSearch = new GanhuoSearch(results1, Constant.TECH_IOS);
    ...
    public void searchWord(String searchString) {
        ((GanhuoPresenter) persenter).getHttpSearch(searchString,Constant.TECH_IOS,20,1);
    }
}
